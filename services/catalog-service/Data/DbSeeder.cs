...
public static class DbSeeder
{
    public static void Seed(CatalogDbContext context)
    {
        ...
        // Seeded with no CreatedByUserId — these predate the enrichment
        // feature entirely, the same way real historical data would. The
        // catalog has to render them fine with "Unknown" as the creator,
        // not just handle identity-service being unreachable.
